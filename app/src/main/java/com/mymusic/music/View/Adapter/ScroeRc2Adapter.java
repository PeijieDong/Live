 ...
 **/
public class ScroeRc2Adapter extends BaseQuickAdapter<Scroe.DataBean.ListBean,BaseViewHolder> {

    public ScroeRc2Adapter(int layoutResId, @Nullable List<Scroe.DataBean.ListBean> data) {
