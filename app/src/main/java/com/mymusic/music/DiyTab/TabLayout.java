...
public class TabLayout extends HorizontalScrollView {
    ...
    public TabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, com.mymusic.music.R.styleable.TabLayout,
                defStyleAttr, com.mymusic.music.R.style.Widget_Design_TabLayout);

        mTabStrip.setSelectedIndicatorHeight(
                a.getDimensionPixelSize(com.mymusic.music.R.styleable.TabLayout_tabIndicatorHeight, 0));
        mTabStrip.setSelectedIndicatorColor(a.getColor(com.mymusic.music.R.styleable.TabLayout_tabIndicatorColor, 0));

        mTabPaddingStart = mTabPaddingTop = mTabPaddingEnd = mTabPaddingBottom = a
                .getDimensionPixelSize(com.mymusic.music.R.styleable.TabLayout_tabPadding, 0);
        mTabPaddingStart = a.getDimensionPixelSize(com.mymusic.music.R.styleable.TabLayout_tabPaddingStart,
                mTabPaddingStart);
        mTabPaddingTop = a.getDimensionPixelSize(com.mymusic.music.R.styleable.TabLayout_tabPaddingTop,
                mTabPaddingTop);
        mTabPaddingEnd = a.getDimensionPixelSize(com.mymusic.music.R.styleable.TabLayout_tabPaddingEnd,
                mTabPaddingEnd);
        mTabPaddingBottom = a.getDimensionPixelSize(com.mymusic.music.R.styleable.TabLayout_tabPaddingBottom,
                mTabPaddingBottom);

        mTabTextAppearance = a.getResourceId(com.mymusic.music.R.styleable.TabLayout_tabTextAppearance,
                com.mymusic.music.R.style.TextAppearance_Design_Tab);
        ...
        if (a.hasValue(com.mymusic.music.R.styleable.TabLayout_tabTextColor)) {
            // If we have an explicit text color set, use it instead
            mTabTextColors = a.getColorStateList(com.mymusic.music.R.styleable.TabLayout_tabTextColor);
        }

        if (a.hasValue(com.mymusic.music.R.styleable.TabLayout_tabSelectedTextColor)) {
            // We have an explicit selected text color set, so we need to make merge it with the
            // current colors. This is exposed so that developers can use theme attributes to set
            // this (theme attrs in ColorStateLists are Lollipop+)
            final int selected = a.getColor(com.mymusic.music.R.styleable.TabLayout_tabSelectedTextColor, 0);
            mTabTextColors = createColorStateList(mTabTextColors.getDefaultColor(), selected);
        }

        mRequestedTabMinWidth = a.getDimensionPixelSize(com.mymusic.music.R.styleable.TabLayout_tabMinWidth,
                INVALID_WIDTH);
        mRequestedTabMaxWidth = a.getDimensionPixelSize(com.mymusic.music.R.styleable.TabLayout_tabMaxWidth,
                INVALID_WIDTH);
        mTabBackgroundResId = a.getResourceId(com.mymusic.music.R.styleable.TabLayout_tabBackground, 0);
        mContentInsetStart = a.getDimensionPixelSize(com.mymusic.music.R.styleable.TabLayout_tabContentStart, 0);
        mMode = a.getInt(com.mymusic.music.R.styleable.TabLayout_tabMode, MODE_FIXED);
        mTabGravity = a.getInt(com.mymusic.music.R.styleable.TabLayout_tabGravity, GRAVITY_FILL);
        a.recycle();

        // TODO add attr for these
        final Resources res = getResources();
        mTabTextMultiLineSize = res.getDimensionPixelSize(com.mymusic.music.R.dimen.design_tab_text_size_2line);
        mScrollableTabMinWidth = res.getDimensionPixelSize(com.mymusic.music.R.dimen.design_tab_scrollable_min_width);
    ...
    public static final class Tab {
         ...
         * to {@link #)}. Similarly, if this layout contains an
            ...
            if (mCustomView == null) {
                ...
                if (mIconView == null) {
                    ImageView iconView = (ImageView) LayoutInflater.from(getContext())
                            .inflate(com.mymusic.music.R.layout.design_layout_tab_icon, this, false);
                    addView(iconView, 0);
                    mIconView = iconView;
                }
                if (mTextView == null) {
                    TextView textView = (TextView) LayoutInflater.from(getContext())
                            .inflate(com.mymusic.music.R.layout.design_layout_tab_text, this, false);
                    addView(textView);
                    mTextView = textView;
        ...
        public void draw(Canvas canvas) {
            ...
            if (mIndicatorLeft >= 0 && mIndicatorRight > mIndicatorLeft) {
                if(mSelectedIndicatorWidth > 0 && mMinTabWidth >= mSelectedIndicatorWidth){
                    ...
                    canvas.drawRect(left,getHeight() - mSelectedIndicatorHeight,right,getHeight(),mSelectedIndicatorPaint);
                }else {
